  ...
  <div>
    <q-card >
      <q-form @submit.prevent="onSubmit" @reset="onReset">
        <!-- <q-card-section> -->
          <div class="three_d q-pa-sm bg-cyan-7 text-white">{{$t('feestype')}}</div>
        <!-- </q-card-section> -->
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
          ...
          <n-name icon="explore" :label="$t('Fees Code')" class="q-mb-sm" ref="modalName" autofocus="autofocus" refname="name" :name.sync="form.name"/>
