  ...
  <div>
    <q-card >
      <q-form @submit.prevent="onSubmit" @reset="onReset">
        <!-- <q-card-section> -->
          <div class="three_d q-pa-sm bg-cyan-7 text-white">{{$t('Add Income')}}</div>
        <!-- </q-card-section> -->
        ...
        />
          ...
          <n-simple icon="description" class="q-mb-sm" :label="$t('Invoice Number')"  :name.sync="form.description"/>
          <n-simple icon="description" class="q-mb-sm" :label="$t('Date')"  :name.sync="form.description"/>
          <n-simple icon="description" class="q-mb-sm" :label="$t('Amount')"  :name.sync="form.description"/>
          <n-simple icon="description" class="q-mb-sm" :label="$t('Attach Document')"  :name.sync="form.description"/>
