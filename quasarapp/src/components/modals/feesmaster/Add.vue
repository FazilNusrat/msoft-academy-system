  ...
  <div>
    <q-card >
      <q-form @submit.prevent="onSubmit" @reset="onReset">
        ...
        <q-card-section class="row items-center q-pb-none three_d q-pa-sm bg-cyan-7 text-white">{{$t('Add Fees Master')}}
               <q-space />
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
          ...
          <n-simple icon="description" :label="$t('Due Date')" class="q-mb-sm" :name.sync="form.description"/>
          <n-simple icon="description" :label="$t('Amount')" class="q-mb-sm" :name.sync="form.description"/>
          <n-simple icon="description" :label="$t('Percentage')" class="q-mb-sm" :name.sync="form.description"/>
          <n-simple icon="description" :label="$t('Fine Amount')"  :name.sync="form.description"/>
