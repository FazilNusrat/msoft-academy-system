  ...
  <div>
    <q-card >
      <q-form @submit.prevent="onSubmit" @reset="onReset">
        <!-- <q-card-section> -->
          <div class="three_d q-pa-sm bg-cyan-7 text-white">{{$t('Lesson Plan')}}</div>
        <!-- </q-card-section> -->
        ...
        />
         <a-select
          ...
          @filter="filterTimes"
        />
          <n-simple icon="description" :label="$t('Lesson Name')"  :name.sync="form.description"/>
