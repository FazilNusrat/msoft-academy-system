  ...
  <div>
    <q-card >
      <q-form @submit.prevent="onSubmit" @reset="onReset">
       ...
       <q-card-section class="row items-center q-pb-none three_d q-pa-sm bg-cyan-7 text-white">{{$t('Add Fees')}}
               <q-space />
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
          ...
          <n-simple icon="description" :label="$t('Search By Keyword')"  :name.sync="form.description"/>
