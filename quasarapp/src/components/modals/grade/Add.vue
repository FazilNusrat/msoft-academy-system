  ...
  <div>
    <q-card >
      <q-form @submit.prevent="onSubmit" @reset="onReset">
        <!-- <q-card-section> -->
          <div class="three_d q-pa-sm bg-cyan-7 text-white">{{$t('Grade')}}</div>
        <!-- </q-card-section> -->
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
          ...
          @filter="filterTimes"
        />
          <n-name icon="explore" :label="$t('Grade Name')" class="q-mb-sm" ref="modalName" autofocus="autofocus" refname="name" :name.sync="form.name"/>
          <n-simple icon="description" class="q-mb-sm" :label="$t('Percent Upto')"  :name.sync="form.description"/>
          <n-simple icon="description" class="q-mb-sm" :label="$t('Percent From')"  :name.sync="form.description"/>
          <n-simple icon="description" class="q-mb-sm" :label="$t('Grade Point')"  :name.sync="form.description"/>
          <n-simple icon="description" class="q-mb-sm" :label="$t('Description')"  :name.sync="form.description"/>
