  ...
  <div>
    <q-card >
      <q-form @submit.prevent="onSubmit" @reset="onReset">
        ...
        <q-card-section class="row items-center q-pb-none three_d q-pa-sm bg-cyan-7 text-white">{{$t('Add Fees Discount')}}
               <q-space />
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
          ...
          <n-name icon="explore" :label="$t('Discount Code')" class="q-mb-sm" ref="modalName" autofocus="autofocus" refname="name" :name.sync="form.name"/>
          <n-name icon="explore" :label="$t('Amount')" class="q-mb-sm" ref="modalName" autofocus="autofocus" refname="name" :name.sync="form.name"/>
