<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Fees Forward Entry</h-title>
...
import NAddModal from 'src/components/modals/feesforward/Add.vue'
import NEditModal from 'src/components/modals/feesforward/Edit.vue'
