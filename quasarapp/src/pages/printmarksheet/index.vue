<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Print Mark Sheet Entry</h-title>
    ...
    <div>
      <n-table :title="$t('printmarksheetList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/printmarksheet/Add.vue'
import NEditModal from 'src/components/modals/printmarksheet/Edit.vue'
