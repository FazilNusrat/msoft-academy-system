<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Lesson Plan Entry</h-title>
...
import NAddModal from 'src/components/modals/lessonplan/Add.vue'
import NEditModal from 'src/components/modals/lessonplan/Edit.vue'
