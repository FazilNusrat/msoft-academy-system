<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Manage Syllabus Status Entry</h-title>
    ...
    <div>
      <n-table :title="$t('incomesearchList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/ManageSyllabusStatus/Add.vue'
import NEditModal from 'src/components/modals/ManageSyllabusStatus/Edit.vue'
