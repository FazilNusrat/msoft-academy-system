<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Income Head Entry</h-title>
    ...
    <div>
      <n-table :title="$t('incomeheadList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/incomehead/Add.vue'
import NEditModal from 'src/components/modals/incomehead/Edit.vue'
