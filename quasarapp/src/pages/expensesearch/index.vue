<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Expense Search Entry</h-title>
    ...
    <div>
      <n-table :title="$t('expensesearchList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/expensesearch/Add.vue'
import NEditModal from 'src/components/modals/expensesearch/Edit.vue'
