<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Income Search Entry</h-title>
...
import NAddModal from 'src/components/modals/incomesearch/Add.vue'
import NEditModal from 'src/components/modals/incomesearch/Edit.vue'
