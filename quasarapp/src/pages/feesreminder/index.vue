<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>fees Reminder Entry</h-title>
...
import NAddModal from 'src/components/modals/feesreminder/Add.vue'
import NEditModal from 'src/components/modals/feesreminder/Edit.vue'
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'description',classes: 'bg-grey-2 ellipsis', align: 'center', label: '2', field: row=>row.description, sortable: true },
        { name: 'description',classes: 'bg-grey-2 ellipsis', align: 'center', label: '5', field: row=>row.description, sortable: true },
        { name: 'description',classes: 'bg-grey-2 ellipsis', align: 'center', label: '10', field: row=>row.description, sortable: true },
        { name: 'description',classes: 'bg-grey-2 ellipsis', align: 'center', label: '15', field: row=>row.description, sortable: true },
