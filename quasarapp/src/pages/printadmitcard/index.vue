<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Print Admit Card Entry</h-title>
    ...
    <div>
      <n-table :title="$t('printadmitcardList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/printadmitcard/Add.vue'
import NEditModal from 'src/components/modals/printadmitcard/Edit.vue'
