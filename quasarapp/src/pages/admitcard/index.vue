<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Admitcard Entry</h-title>
...
import NAddModal from 'src/components/modals/admitcard/Add.vue'
import NEditModal from 'src/components/modals/admitcard/Edit.vue'
