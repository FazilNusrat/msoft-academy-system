<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Expense Head Entry</h-title>
    ...
    <div>
      <n-table :title="$t('expenseheadList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/expensehead/Add.vue'
import NEditModal from 'src/components/modals/expensehead/Edit.vue'
