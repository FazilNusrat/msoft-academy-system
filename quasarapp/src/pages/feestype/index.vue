<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Fees Type Entry</h-title>
    ...
    <div>
      <n-table :title="$t('feestypeList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/feestype/Add.vue'
import NEditModal from 'src/components/modals/feestype/Edit.vue'
