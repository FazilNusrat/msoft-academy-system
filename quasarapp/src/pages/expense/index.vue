<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <div>
      <n-table :title="$t('feesList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/expense/Add.vue'
import NEditModal from 'src/components/modals/expense/Edit.vue'
