<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <div>
      <n-table :title="$t('gradeList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/grade/Add.vue'
import NEditModal from 'src/components/modals/grade/Edit.vue'
