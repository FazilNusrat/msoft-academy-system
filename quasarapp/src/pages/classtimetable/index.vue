<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Class Timetable Entry</h-title>
...
import NAddModal from 'src/components/modals/classtimetable/Add.vue'
import NEditModal from 'src/components/modals/classtimetable/Edit.vue'
