<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>Fees Master Entry</h-title>
    ...
    <div>
      <n-table :title="$t('Fees Master List')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/feesmaster/Add.vue'
import NEditModal from 'src/components/modals/feesmaster/Edit.vue'
