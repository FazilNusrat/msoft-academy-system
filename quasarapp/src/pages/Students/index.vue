  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: 'first name', align: 'center', label: 'First Name', field: row=>row.first_name, sortable: true },
        ...
        { name: 'mobile number',classes: 'bg-grey-2 ellipsis', align: 'center', label: 'Phone', field: row=>row.mobile_number, sortable: true },
