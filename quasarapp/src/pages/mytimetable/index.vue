<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <h-title>My Time Table Entry</h-title>
    ...
    <div>
      <n-table :title="$t('mytimetableList')" :loading="loading" :data="data" :pagination.sync="pagination" @del="del" @info="info" @edit="edit" :filter.sync="filter" :columns="columns" @request="onRequest" />
...
import NAddModal from 'src/components/modals/mytimetable/Add.vue'
import NEditModal from 'src/components/modals/mytimetable/Edit.vue'
